...
public class CheckController {
	...
	*/
	...
	@PostMapping("checkbox")//RequestParam : 평소에는 생략하지만 Array타입이면 생략할 수 없다.
	public String checkbox(@RequestParam("fruit") @ModelAttribute("fruits") ArrayList<String> fruits, Model model) {
